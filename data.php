<?php
    ...
    $result = mysqli_query($conn, "SELECT O_PHP_FILTERS.project_name, O_PHP_FILTERS.tower , O_SBU_MAPPING.sbu_identifier , O_PHP_FILTERS.data_table 
    FROM O_PROJECTS 
    ...
    ORDER BY project_name,tower,sbu_identifier ;");
